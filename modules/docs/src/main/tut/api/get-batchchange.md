...
changes       | Array of SingleChange | Array of single changes within a batch change. A *SingleChange* can either be a [SingleAddChange](https://www.vinyldns.io/api/batchchange-modelhtml#singleaddchange-attributes) or a [SingleDeleteChange](https://www.vinyldns.io/api/batchchange-model.html#singledeletechange-). |
