...
import vinyldns.client.models.membership.{GroupResponse, MemberListResponse}
...
class GroupViewPageSpec extends WordSpec with Matchers with MockFactory with SharedTestData {
  ...
  class Fixture(group: GroupResponse = initialGroup) {
    val mockHttp = mock[Http]

    (mockHttp.get[GroupResponse] _)
    ...
    (mockHttp.get[MemberListResponse] _)
