...
object MembersTable {
  ...
  case class Props(group: Group, http: Http, refreshGroup: Unit => Callback)

  case class State(memberList: Option[MemberList] = None)
  ...
  class Backend(bs: BackendScope[Props, State]) {
    ...
    def groupManagerWidget(P: Props, user: User): TagMod = {
    ...
    def deleteMember(P: Props, user: User): Callback =
    ...
    def removeGroupAdmin(P: Props, user: User): Callback =
      P.http.withConfirmation(
    ...
    def addGroupAdmin(P: Props, user: User): Callback =
      P.http.withConfirmation(
