...
object RecordSetChangeTable {
  ...
  case class State(
      recordSetChangeList: Option[RecordSetChangeListResponse] = None,
      pagination: Pagination = Pagination(),
      maxItems: Int,
      showViewRecordSetModal: Boolean = false,
      toBeViewed: Option[RecordSetResponse] = None
  )
  ...
  class Backend(bs: BackendScope[Props, State]) {
    ...
    def listRecordSetChanges(P: Props, S: State, startFrom: Option[String] = None): Callback = {
      val onSuccess = { (_: HttpResponse, parsed: Option[RecordSetChangeListResponse]) =>
    ...
    def makeViewRecordModalVisible(recordSet: Option[RecordSetResponse]): Callback =
