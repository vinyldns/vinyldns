...
object GroupsTable {
  ...
  case class State(
      groupsList: Option[GroupListResponse] = None,
      groupNameFilter: Option[String] = None,
      showUpdateGroup: Boolean = false,
      toBeUpdated: Option[GroupResponse] = None,
  ...
  class Backend(bs: BackendScope[Props, State]) {
    ...
    def makeUpdateFormVisible(toBeUpdated: GroupResponse): Callback =
    ...
    def deleteGroup(P: Props, S: State, group: GroupResponse): Callback =
