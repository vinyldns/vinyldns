...
object BatchChangeSummary extends OptionRW with BatchChangeStatusRW {
  implicit val batchChangeSummaryRw: ReadWriter[BatchChangeSummary] = macroRW[BatchChangeSummary]
}
