...
class VinylDNSClient(object):
    ...
    def list_recordsets(self, zone_id, start_from=None, max_items=None, record_name_filter=None, record_type_filter=None, sort=None, **kwargs):
        """
        ...
        :param sort: sort order by recordset name
        :return: the content of the response
        """
        args = []
        if start_from:
        ...
        if sort:
            args.append(u'sort={0}'.format(sort))
