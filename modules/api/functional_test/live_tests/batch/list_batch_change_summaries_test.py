...
def test_list_batch_change_summaries_success(list_fixture):
    ...
    list_fixture.check_batch_change_summaries_page_accuracy(batch_change_summaries_result, size=5)
...
def test_list_batch_change_summaries_with_start_from(list_fixture):
    ...
    list_fixture.check_batch_change_summaries_page_accuracy(batch_change_summaries_result, size=4, start_from=1)
...
def test_list_batch_change_summaries_with_next_id(list_fixture):
    ...
    list_fixture.check_batch_change_summaries_page_accuracy(next_page_result, size=3, start_from=batch_change_summaries_result['nextId'])
