...
def test_list_zones_success(list_zone_context, shared_zone_test_context):
    ...
    """
    result = shared_zone_test_context.list_zones_client.list_generate_zones(name_filter=f"*{shared_zone_test_context.partition_id}", status=200)
...
def test_list_zones_by_admin_group_name(list_zone_context, shared_zone_test_context):
    ...
    """
    result = shared_zone_test_context.list_zones_client.list_generate_zones(name_filter=f"list-zones-group{shared_zone_test_context.partition_id}", search_by_admin_group=True, status=200)
    retrieved = result["zones"]
...
def test_list_zones_by_admin_group_name_with_wildcard(list_zone_context, shared_zone_test_context):
    ...
    """
    result = shared_zone_test_context.list_zones_client.list_generate_zones(name_filter=f"*group{shared_zone_test_context.partition_id}", search_by_admin_group=True, status=200)
    retrieved = result["zones"]
...
def test_list_zones_max_items_100(shared_zone_test_context):
    ...
    """
    result = shared_zone_test_context.list_zones_client.list_generate_zones(status=200)
...
def test_list_zones_invalid_max_items_fails(shared_zone_test_context):
    ...
    """
    errors = shared_zone_test_context.list_zones_client.list_generate_zones(max_items=700, status=400)
...
def test_list_zones_no_authorization(shared_zone_test_context):
    ...
    """
    shared_zone_test_context.list_zones_client.list_generate_zones(sign_request=False, status=401)
...
def test_list_zones_no_search_first_page(list_zone_context, shared_zone_test_context):
    ...
    """
    result = shared_zone_test_context.list_zones_client.list_generate_zones(name_filter=f"*{shared_zone_test_context.partition_id}", max_items=3)
    zones = result["zones"]
...
def test_list_zones_no_search_second_page(list_zone_context, shared_zone_test_context):
    ...
    """
    result = shared_zone_test_context.list_zones_client.list_generate_zones(name_filter=f"*{shared_zone_test_context.partition_id}",
...
def test_list_zones_with_search_first_page(list_zone_context, shared_zone_test_context):
    ...
    """
    result = shared_zone_test_context.list_zones_client.list_generate_zones(name_filter=f"*searched*{shared_zone_test_context.partition_id}", max_items=2, status=200)
    zones = result["zones"]
...
def test_list_zones_with_no_results(shared_zone_test_context):
    ...
    """
    result = shared_zone_test_context.list_zones_client.list_generate_zones(name_filter="this-wont-be-found", max_items=2, status=200)
    zones = result["zones"]
...
def test_list_zones_with_search_last_page(list_zone_context, shared_zone_test_context):
    ...
    """
    result = shared_zone_test_context.list_zones_client.list_generate_zones(name_filter=f"*test-searched-3{shared_zone_test_context.partition_id}",
                                                                   start_from=list_zone_context.search_zone2["name"],
                                                                   max_items=2,
                                                                   status=200)
    zones = result["zones"]
...
def test_list_zones_ignore_access_success(shared_zone_test_context):
    ...
    """
    result = shared_zone_test_context.list_zones_client.list_generate_zones(ignore_access=True, status=200)
    retrieved = result["zones"]
...
def test_list_zones_ignore_access_success_with_name_filter(shared_zone_test_context):
    ...
    """
    result = shared_zone_test_context.list_zones_client.list_generate_zones(name_filter=shared_zone_test_context.shared_zone["name"].rstrip("."), ignore_access=True, status=200)
    retrieved = result["zones"]
