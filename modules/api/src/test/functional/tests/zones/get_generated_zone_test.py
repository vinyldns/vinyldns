...
def test_get_zone_by_id(shared_zone_test_context):
    ...
    result = client.get_generate_zone(shared_zone_test_context.system_test_zone["id"], status=200)
...
def test_get_zone_shared_by_id_as_owner(shared_zone_test_context):
    ...
    result = client.get_generate_zone(shared_zone_test_context.shared_zone["id"], status=200)
    retrieved = result["zone"]
...
def test_get_zone_private_by_id_fails_without_access(shared_zone_test_context):
    ...
    client.get_generate_zone(shared_zone_test_context.ok_zone["id"], status=403)
...
def test_get_zone_by_name(shared_zone_test_context):
    ...
    result = client.get_generate_zone_by_name(shared_zone_test_context.system_test_zone["name"], status=200)["zone"]
...
def test_get_zone_by_name_shared_zone_succeeds(shared_zone_test_context):
    ...
    result = client.get_generate_zone_by_name(shared_zone_test_context.shared_zone["name"], status=200)["zone"]
...
def test_get_zone_nameservers(shared_zone_test_context):
    """
...
def test_get_zone_dns_allowed_providers(shared_zone_test_context):
    """
    Test that you can get possible backend ids for zones
    """
    client = shared_zone_test_context.ok_vinyldns_client
