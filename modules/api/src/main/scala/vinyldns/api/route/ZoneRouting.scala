...
class ZoneRoute(
  ...
  private def DEFAULT_MAX_ITEMS: Int = RuntimeVinylDNSConfig.limitsConfig.ZONE_ROUTING_DEFAULT_MAX_ITEMS
  private def MAX_ITEMS_LIMIT: Int = RuntimeVinylDNSConfig.limitsConfig.ZONE_ROUTING_MAX_ITEMS_LIMIT
